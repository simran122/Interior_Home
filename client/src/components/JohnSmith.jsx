    ...
    return (
        <>
            ...
            <Box
                ...
                <motion.img initial={preHover} whileHover={hovered} src={photo4} style={{ borderRadius: "20px", maxWidth: "auto", minHeight: "auto" }} />
                <Box sx={{ my: "1rem" }}>
                    <Typography variant='h2'>John Smith</Typography>
                    <Typography variant='h6' sx={{ fontFamily: "Jost", color: "primary.light", mb: "1.4rem" }}>Designer</Typography>
                    <Typography variant='h6' sx={{ fontFamily: "Jost", color: "primary.light", textAlign: "justify" }}>Welcome to the world of creativity and innovation! I'm John Smith, an enthusiastic interior designer here at Iterno. With a passion for transforming spaces into captivating experiences, I'm dedicated to infusing life and personality into every room I touch.</Typography>
                    <Stack direction="row" spacing={1.5} alignItems="center">
                        ...
                        <Typography variant='h6' sx={{ fontFamily: "Jost", color: "primary.light" }}>JohnSmith@Interno.com</Typography>
                    </Stack>
                    <Stack direction="row" spacing={1.5} alignItems="center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                            <circle cx="26" cy="26" r="26" fill="white" />
            ...
            <Box
                ...
                sx={{ mx: { xs: "1.5rem", sm: "auto" }, maxWidth: { xs: "100%", sm: "70%" } }}>
                <Typography variant='h2' sx={{ mb: "1rem" }}>Short Biography</Typography>
                <Typography variant='h6' sx={{ fontFamily: "Jost", color: "primary.light", textAlign: "justify" }}>My journey into the world of interior design started early, with an insatiable curiosity for how spaces can influence emotions and behaviors. I pursued my formal education in Interior Design from the prestigious The London School of Design, where I honed my skills and learned to balance aesthetics with functionality.

                    With 7 years of professional experience under my belt, I've had the privilege of working on a diverse range of projects. From cozy urban apartments to luxurious suburban homes, each project has offered me the opportunity to blend my creativity with the unique visions of my clients. My experience has taught me that every space has its own story waiting to be told, and I'm here to help you tell yours.</Typography>
            ...
            <Box
                ...
                sx={{ mx: { xs: "1.5rem", sm: "auto" }, maxWidth: { xs: "100%", sm: "70%" }, my: "2rem" }}>
                <Typography variant='h2' sx={{ mb: "1rem" }}>Approach</Typography>
                <Typography variant='h6' sx={{ fontFamily: "Jost", color: "primary.light", textAlign: "justify" }}>My approach to design is collaborative and client-centric. I thrive on open communication and enjoy engaging with clients throughout the design journey. From conceptualization to execution, I'm committed to ensuring that your vision is realized in the most remarkable way possible. My attention to detail and commitment to quality ensures that every element, from color palettes to furniture selections, is thoughtfully considered.</Typography>
