        ...
        <>
            ...
            <Box
                ...
                <Box sx={{ my: "1rem" }}>
                    ...
                    <Typography variant='h6' sx={{ fontFamily: "Jost", color: "primary.light", textAlign: "justify" }}>Welcome to the world of creativity and innovation! I'm Nattasha Julie, an enthusiastic interior designer here at Iterno. With a passion for transforming spaces into captivating experiences, I'm dedicated to infusing life and personality into every room I touch.</Typography>
                    <Stack direction="row" spacing={1.5} alignItems="center">
                        ...
                        <Typography variant='h6' sx={{ fontFamily: "Jost", color: "primary.light" }}>Julie@Interno.com</Typography>
                    </Stack>
                    <Stack direction="row" spacing={1.5} alignItems="center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                            <circle cx="26" cy="26" r="26" fill="white" />
                        ...
                        <Typography variant='h6' sx={{ fontFamily: "Jost", color: "primary.light" }}>+1(378)4001234</Typography>
                    </Stack>
                    <Stack direction="row" spacing={1.5} alignItems="center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                            <circle cx="26" cy="26" r="26" fill="white" />
